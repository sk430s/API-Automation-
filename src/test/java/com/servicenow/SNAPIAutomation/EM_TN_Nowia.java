...
public class EM_TN_Nowia extends BaseTestSpecs {
	
		
	
	@Test(description = "Test Create EM_TN\n")
	public void testRESTTicketCreate_EM_TN() throws IOException {

		RestAPI restAPI = new RestAPI();
		String fileName = "EM_TN_Create.xml";
	...
	@Test(description = "Test Get REST API EM_TN")	
public void testRESTTicketGet_EM_TN() throws IOException {
		
			
		RestAPI restAPI = new RestAPI();
		String fileName = "EM_GetTN_Nowia.xml";
		String EndPoint = config.getProperty("createEMTicket");
		Response response = restAPI.postRestAPI(EndPoint, fileName);
		System.out.println(response.getStatusCode());
		XmlPath jsXpath = new XmlPath(response.asString());// Converting string into xml path to assert
		...
		String AccessHoursStart = jsXpath.get("Envelope.Body.getTicketResponse.getTicketOutput.LocationDetailsInfoList.LocationDetailsInfo.PremiseAccessHoursInfoList.AccessHoursInfo[1].Start");
		Assert.assertEquals(jsXpath.get("Envelope.Body.getTicketResponse.getTicketOutput.LocationDetailsInfoList.LocationDetailsInfo.PremiseAccessHoursInfoList.AccessHoursInfo[1].Start"),AccessHoursStart);
		System.out.print(" Start Time :" +AccessHoursStart);
		
		String AccessHoursEnd = jsXpath.get("Envelope.Body.getTicketResponse.getTicketOutput.LocationDetailsInfoList.LocationDetailsInfo.PremiseAccessHoursInfoList.AccessHoursInfo[2].End");
		Assert.assertEquals(jsXpath.get("Envelope.Body.getTicketResponse.getTicketOutput.LocationDetailsInfoList.LocationDetailsInfo.PremiseAccessHoursInfoList.AccessHoursInfo[2].End"),AccessHoursEnd);
	...
	@Test(description = "Test Update Logs REST API EM_TN_Nowia")
	public void testRESTTicketUpdate_EM_TN() throws IOException {

		RestAPI restAPI = new RestAPI();
		String fileName = "EM_UpdateLogTN_Nowia.xml";
		String EndPoint = config.getProperty("createEMTicket");
		Response response = restAPI.postRestAPI(EndPoint, fileName);
		String jsonString = response.asString();
		System.out.println(jsonString);
	...
	@Test(description = "Case Escalation EM_TN_Nowia")
	public void testRESTTicketCase_EM_TN() throws IOException {

		RestAPI restAPI = new RestAPI();
		String fileName = "EM_TN_CaseEscalation_Nowia.xml";
		String EndPoint = config.getProperty("createEMTicket");
		Response response = restAPI.postRestAPI(EndPoint, fileName);
		String jsonString = response.asString();
		System.out.println(jsonString);
	...
	@Test(description = "EDF REST API EM_TN")

	public void testEDF_TN_Request() throws IOException {
		
		RestAPI restAPI = new RestAPI();
		String fileName = "EDF_TN_Request.xml";
	...
	public void testRESTTicketClose_EM_TN() throws IOException {
		...
		RestAPI restAPI = new RestAPI();
		String fileName = "EM_TN_Close.xml";
		String EndPoint = config.getProperty("createEMTicket");
		Response response = restAPI.postRestAPI(EndPoint, fileName);
		System.out.println(response.getStatusCode());
